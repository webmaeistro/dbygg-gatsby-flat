[![Code Climate](https://codeclimate.com/github/webmaeistro/gatsby-material-starter/badges/gpa.svg)](https://codeclimate.com/github/webmaeistro/gatsby-material-starter)
[![Issue Count](https://codeclimate.com/github/webmaeistro/gatsby-material-starter/badges/issue_count.svg)](https://codeclimate.com/github/webmaeistro/gatsby-material-starter)
[![Codacy Badge](https://api.codacy.com/project/badge/Grade/990fb54ea8094f2aa0ed77f14e859820)](https://www.codacy.com/app/webmaeistro/gatsby-material-starter?utm_source=github.com&utm_medium=referral&utm_content=webmaeistro/gatsby-material-starter&utm_campaign=Badge_Grade)
...
```sh
gatsby new YourProjectName https://github.com/webmaeistro/gatsby-material-starter
...
```sh
git clone https://github.com/webmaeistro/gatsby-material-starter YourProjectName # Clone the project
cd YourProjectname
...
module.exports = {
  ...
  disqusShortname: "https-webmaeistro-github-io-gatsby-material-starter", // Disqus shortname.
  ...
  userLocation: "Horten, Vestfold, Norge", // User location to display in the author segment.
  userAvatar: "https://www.facebook.com/photo.php?fbid=131543254927452&set=a.103044797777298&type=3&source=11&referrer_profile_id=100042153335699", // User avatar to display in the author segment.
  userDescription:
    "Danielsen Bygg ble startet opp i Oktober 2018, av snekkeren Morten Danielsen, fra Horten. Morten har god erfaring med alt som har med snekkerarbeid å gjøre. Selskapet tar på seg jobber som totalrenovering, tilbygg, tak, malejobber, og alt annet snekkerarbeid. Ta kontakt på epost eller på mobil å få gratis befaring!", // User description to display in the author segment.
  // Links to social profiles/projects you want to display in the author segment/navigation bar.
  userLinks: [
    {
      label: "Tlf: 984 80 400",
      url: "tell:"984 80 400",
...
backend:
  ...
  repo: webmaeistro/gatsby-material-starter # Repo for pushing new commits. Make sure to replace with your repo!
```
